...
1. How would you describe acessibility on the web to someone new to programming?
   Acessibility is there to help anyone who might have trouble viewing the site as it is meant to be. This can include a visual handicap or even a slow internet that doesn't load images. This also includes being able to view your website on different screen sizes.

2. Talk about 3 different things you can do to ensure your website is accessible.
   Using <alt> tags, discriptive links, using the Viewport meta tag for screen sizes.

3. How would you explain the concept of a variable to someone new to programming?
   a <var>, or also <const>, <let>, is a way to allow you to create a piece of information, called an operator, that can be called back upon once, or even multiple time within the page. They have a unique identifier so they are not confused with anything else.

4. What is the purpose of using functions in code?
   Functions are blocks of code that are designed to excecute at particular task when called upon. They have unique identifiers and are only executed when something envokes it.
